  ...
  return (
    <div
      ...
      className={cn(
        ...
        "[&_p]:my-3",
        "[&_h1]:mb-3 [&_h1]:mt-5 [&_h1]:text-[1.428571em] [&_h1]:font-semibold [&_h2]:mb-3 [&_h2]:mt-5 [&_h2]:text-[1.285714em] [&_h2]:font-semibold [&_h3]:mb-2 [&_h3]:mt-4 [&_h3]:text-[1.142857em] [&_h3]:font-semibold [&_h4]:mb-2 [&_h4]:mt-4 [&_h4]:font-semibold",

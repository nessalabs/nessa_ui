...
export const contracts = Object.freeze([
  ...
  contract("TOKEN-004", "Coordinated typography levels and the constrained scale chain own every Nessa text size.", "docs/architecture/design-system-contract.md#constrained-ui-scale", "enforced", "typography-scale"),
  ...
  contract("PARSE-001", "Wire vocabularies are frozen objects with derived unions rather than TypeScript enums.", "docs/architecture/design-system-contract.md#wire-parsing-discipline", "enforced", "parser-hygiene"),
  contract("PARSE-002", "Exported const vocabularies are frozen at runtime, not only at compile time.", "docs/architecture/design-system-contract.md#wire-parsing-discipline", "enforced", "parser-hygiene"),
  contract("PARSE-003", "Values decoded from a wire are narrowed through the shared readers, never by hand.", "docs/architecture/design-system-contract.md#wire-parsing-discipline", "enforced", "parser-hygiene"),
  contract("PKG-001", "Each published package declares its runtime floor: React's peers for the React package, and none at all for the framework-free parser.", "docs/architecture/design-system-contract.md#root-exports-and-build-shape", "enforced", "package-artifacts"),
  contract("PKG-002", "Exports, side effects, and the parser's contract/fold split preserve the package distribution contract.", "docs/architecture/design-system-contract.md#root-exports-and-build-shape", "enforced", "package-artifacts"),
  contract("PKG-003", "Published artifacts of every package are freshly built and contain required code, CSS where owned, docs, and license.", "docs/architecture/design-system-contract.md#root-exports-and-build-shape", "enforced", "package-artifacts"),
  ...
  contract("A11Y-005", "Focus indication follows field identity, and live regions are mounted before they carry text.", "docs/architecture/design-system-contract.md#accessibility-and-rendering-invariants", "review-required", null, null, "Reviewer confirms the element that reads as the field is the one drawing the focus indicator, reading the editable element's own class surface rather than the component's inventory totals, and that every live region is mounted with its surface and starts empty rather than having aria-live switched on over rendered text."),
  contract("A11Y-006", "Editable surfaces declare whether they draw a focus indicator.", "docs/architecture/design-system-contract.md#accessibility-and-rendering-invariants", "enforced", "accessibility"),

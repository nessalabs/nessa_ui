...
export const contracts = Object.freeze([
  ...
  contract("A11Y-005", "Editable surfaces and live regions follow the frozen focus and announcement rules.", "docs/architecture/design-system-contract.md#accessibility-and-rendering-invariants", "review-required", null, null, "Reviewer confirms a borderless editable surface inside its own bordered container draws no focus outline while a tab-stopped non-editable region does, that each choice is recorded in the focus inventory, and that every live region is mounted before it first carries text."),

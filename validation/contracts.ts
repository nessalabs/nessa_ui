...
export const contracts = Object.freeze([
  ...
  contract("PARSE-001", "Wire vocabularies are frozen objects with derived unions rather than TypeScript enums.", "docs/architecture/agent-stream-parsers.md#why-the-payload-vocabulary-is-shared-not-per-provider", "enforced", "parser-hygiene"),
  contract("PARSE-002", "Exported const vocabularies are frozen at runtime, not only at compile time.", "docs/architecture/agent-stream-parsers.md#why-the-payload-vocabulary-is-shared-not-per-provider", "enforced", "parser-hygiene"),
  contract("PARSE-003", "Values decoded from a wire are narrowed through the shared readers, never by hand.", "docs/architecture/agent-stream-parsers.md#0-what-this-library-is-and-what-it-is-not", "enforced", "parser-hygiene"),

...
export const exceptions = Object.freeze([
  {
    kind: "occurrence",
    contractId: "SRC-002",
    path: "packages/react/src/components/code-editor.tsx",
    needle: "dark:[--nessa-code-foreground:var(--nessa-code-fg-dark)]",
    maximumOccurrences: 1,
    rationale: "Runtime syntax themes supply paired colors; system code mode follows the existing host dark selector until scoped resolved-mode tokens exist.",
    removalCondition: "Replace with provider-scoped resolved-mode selectors when the theme provider contract lands.",
  },
  {
    kind: "occurrence",
    contractId: "SRC-002",
    path: "packages/react/src/components/code-editor.tsx",
    needle: "dark:[--nessa-code-background:var(--nessa-code-bg-dark)]",
  ...
  },
  {
    ...
    contractId: "SRC-002",
    path: "packages/react/src/components/code-editor.tsx",
    needle: "dark:[&_.nessa-code-token]:text-[var(--code-dark)]",
    maximumOccurrences: 1,
    rationale: "Runtime syntax themes supply paired colors; system code mode follows the existing host dark selector until scoped resolved-mode tokens exist.",
    removalCondition: "Replace with provider-scoped resolved-mode selectors when the theme provider contract lands.",
  },

...
export const exceptions = Object.freeze([
  ...
  // Textarea mirrors Input's field focus treatment exactly, so it inherits
  // the same exact transitional light-mode measurements.
  { kind: "focus-contrast", contractId: "A11Y-002", component: "textarea", state: "focus-visible:valid", mode: "light", token: "--ring", opacity: 0.4, surface: "--background", requiredRatio: 3, expectedTokenValue: "oklch(0.556 0 0)", expectedSurfaceValue: "oklch(1 0 0)", rationale: focusRationale, removalCondition: focusRemoval },
  { kind: "focus-contrast", contractId: "A11Y-002", component: "textarea", state: "focus-visible:valid", mode: "light", token: "--ring", opacity: 0.4, surface: "--card", requiredRatio: 3, expectedTokenValue: "oklch(0.556 0 0)", expectedSurfaceValue: "oklch(1 0 0)", rationale: focusRationale, removalCondition: focusRemoval },
  { kind: "focus-contrast", contractId: "A11Y-002", component: "textarea", state: "focus-visible:valid", mode: "light", token: "--ring", opacity: 0.4, surface: "--popover", requiredRatio: 3, expectedTokenValue: "oklch(0.556 0 0)", expectedSurfaceValue: "oklch(1 0 0)", rationale: focusRationale, removalCondition: focusRemoval },
  { kind: "focus-contrast", contractId: "A11Y-002", component: "textarea", state: "focus-visible:invalid", mode: "light", token: "--destructive", opacity: 0.2, surface: "--background", requiredRatio: 3, expectedTokenValue: "oklch(0.577 0.235 27.325)", expectedSurfaceValue: "oklch(1 0 0)", rationale: focusRationale, removalCondition: focusRemoval },
  { kind: "focus-contrast", contractId: "A11Y-002", component: "textarea", state: "focus-visible:invalid", mode: "light", token: "--destructive", opacity: 0.2, surface: "--card", requiredRatio: 3, expectedTokenValue: "oklch(0.577 0.235 27.325)", expectedSurfaceValue: "oklch(1 0 0)", rationale: focusRationale, removalCondition: focusRemoval },
  { kind: "focus-contrast", contractId: "A11Y-002", component: "textarea", state: "focus-visible:invalid", mode: "light", token: "--destructive", opacity: 0.2, surface: "--popover", requiredRatio: 3, expectedTokenValue: "oklch(0.577 0.235 27.325)", expectedSurfaceValue: "oklch(1 0 0)", rationale: focusRationale, removalCondition: focusRemoval },

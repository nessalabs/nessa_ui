...
export const exceptions = Object.freeze([
  ...
  { kind: "focus-contrast", contractId: "A11Y-002", component: "button", state: "focus-visible:destructive", mode: "dark", token: "--destructive", opacity: 0.3, surface: "--background", requiredRatio: 3, expectedTokenValue: "oklch(0.69 0.19 25)", expectedSurfaceValue: "oklch(0.145 0 0)", rationale: focusRationale, removalCondition: focusRemoval },
  { kind: "focus-contrast", contractId: "A11Y-002", component: "button", state: "focus-visible:destructive", mode: "dark", token: "--destructive", opacity: 0.3, surface: "--card", requiredRatio: 3, expectedTokenValue: "oklch(0.69 0.19 25)", expectedSurfaceValue: "oklch(0.195 0 0)", rationale: focusRationale, removalCondition: focusRemoval },
  { kind: "focus-contrast", contractId: "A11Y-002", component: "button", state: "focus-visible:destructive", mode: "dark", token: "--destructive", opacity: 0.3, surface: "--popover", requiredRatio: 3, expectedTokenValue: "oklch(0.69 0.19 25)", expectedSurfaceValue: "oklch(0.195 0 0)", rationale: focusRationale, removalCondition: focusRemoval },

...
export const checkMetadata = Object.freeze({
  ...
  "registry-parity": { phase: "source", inputs: ["registry.json", "public/r/*.json", "packages/react/src/**/*.{ts,tsx}", "packages/agent-stream/src/**/*.ts"], dependsOn: ["theme-parity"], global: false },
  ...
  "provider-surface": { phase: "source", inputs: ["packages/react/src/provider/**/*.{ts,tsx}", "packages/react/src/theme/**/*.{ts,tsx}", "packages/react/src/theme.css", "packages/react/src/lib/portal-container.tsx", "packages/react/src/components/**/*.tsx"], dependsOn: [], global: false },

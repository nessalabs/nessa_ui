...
export const checkMetadata = Object.freeze({
  ...
  "storybook-coverage": { phase: "source", inputs: ["packages/react/src/components/**/*.tsx", "packages/react/src/index.ts", "apps/storybook/stories/**/*.stories.tsx"], dependsOn: [], global: false },
  ...
  accessibility: { phase: "source", inputs: ["packages/react/src/theme.css", "packages/react/src/components/**/*.tsx", "validation/exceptions.ts", "validation/nessa/{contrast-matrix,focus-treatments}.ts"], dependsOn: ["theme-parity"], global: false },
